...
usage()
{
        ...
        echo
        echo "Usage: $0 [-i input_vcf MANIFEST] [-T tumor_analysis_uuid] [-B tumor_bam_name] \ "
        ...
        echo
        echo "  [-i input_vcf]            - Full path to input VCF file generated by mc3_variant.cwl workflow"
...
if [[ "$input_vcf" == "" || "$tumor_analysis_uuid" == "" || "$tumor_bam_name" == "" || "$tumor_aliquot_uuid" == "" || "$tumor_aliquot_name" == "" || "$normal_analysis_uuid" == "" || "$normal_bam_name" == "" || "$normal_aliquot_uuid" == "" || "$normal_aliquot_name" == "" || "$platform" == "" || "$center" == "" ]]
then
        usage
fi
...
python /opt/tcga-vcf-reheader.py "${input_vcf}" "${output_vcf}" $prefix\_$timestamp\_config.yml
#rm -f $prefix\_$timestamp\_config.yml
